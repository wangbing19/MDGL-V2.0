...
public class CusConsultationServiceImpl implements CusConsultationService {
    ...
    public PageObject<CusConsultation> findPageObjects(Map<String, String> map) {
        ...
        String page = map.get("pageCurrent");
      ...
      //1.数据合法性验证
      		...
      		int rowCount = cusConsultationMapper.selectCount(queryWrapper);
      	...
      	//	System.out.println(rowCount);
      		...
      		List<CusConsultation> records =
      				cusConsultationMapper.findPageObjects(name, tel, startIndex, pageSize);
      		//4.对查询结果进行封装并返回
